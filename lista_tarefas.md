...
- Se um usuário tiver uma conta como administrador e cliente, o sistema irá priorizar o cliente, barrando as permissões administrativas;
- Listagem da média de usuários em cada "level";
...
- Implementar as seguintes funcionalidades para **Clientes**
  ...
  - Sistema de pesquisa com alternativas para traçar o nível do usuário;
   ...
   -Tratar o erro do multer de tipo de arquivo do currículo;
